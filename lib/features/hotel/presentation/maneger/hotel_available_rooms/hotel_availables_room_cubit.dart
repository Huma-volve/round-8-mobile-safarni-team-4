...
class HotelAvailableRoomsCubit extends Cubit<HotelRoomsState> {
  final HotelRepository repository;

  HotelAvailableRoomsCubit(this.repository) : super(HotelRoomsInitial());
  ...
  Future<void> fetchHotelRooms(int hotelId) async {
    ...
    try {
      ...
      print(e.toString());
      emit(HotelRoomsError(e.toString()));
    }
  }
}
// 1. States
