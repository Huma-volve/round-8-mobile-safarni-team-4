class BottonData {
  ...
  BottonData({required this.id, required this.label, this.isSelected = false, required this.icon});
}
...
List<BottonData> AdevStyle = [
  BottonData(id: 'Adventure Travel', label: 'Adventure Travel',icon: 'assets/icons/adv travel.svg'),
  BottonData(id: 'City Breaks', label: 'City Breaks', icon: 'assets/icons/city break.svg'),
  BottonData(id: 'Road Trips', label: 'Road Trips', icon: 'assets/icons/road trip.svg'),
  BottonData(id: 'Water Activity', label: 'Water Activity', icon: 'assets/icons/water activity.svg'),
];
